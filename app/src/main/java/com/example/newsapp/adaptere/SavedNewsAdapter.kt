package com.example.newsapp.adaptere
...
import com.example.newsapp.databinding.ItemsSavedNewsBinding
...
class SavedNewsAdapter : RecyclerView.Adapter<SavedNewsAdapter.SavedNewsViewHolder>() {
    ...
    inner class SavedNewsViewHolder(var view: ItemsSavedNewsBinding) :
        RecyclerView.ViewHolder(view.root)
    val differ = AsyncListDiffer(this, diffUtilCallback)
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SavedNewsViewHolder {
        val inflater = LayoutInflater.from(parent.context)
        val view = DataBindingUtil.inflate<ItemsSavedNewsBinding>(
            inflater,
            R.layout.items_saved_news,
            parent,
            false
        )
